...
- Scorecards Array: Must contain EXACTLY 12 objects. The 'name' of each object must EXACTLY match this list in order:
  "Visual Hierarchy", "Typography", "Spacing & Layout", "Accessibility", "CTA Clarity", "Navigation Clarity", "Information Density", "Visual Consistency", "UX Friction", "Emotional Tone", "Mobile Friendliness", "Product Maturity"
- Each scorecard MUST return a 'score' out of 10 (1-10 scale). 
