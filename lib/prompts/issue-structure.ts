...
4. severity: Assign a strict level based on friction. ONLY surface criticism that materially impacts clarity, usability, comprehension, accessibility, cognitive load, or interaction confidence. Avoid low-value nitpicking:
   ...
   - "low": Spacing polish, minor visual styling inconsistencies, or typographic fine-tuning that meaningfully impact perception. Do not flag if the issue is a baseless nitpick.
